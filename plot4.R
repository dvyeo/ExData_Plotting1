...
par(mfrow = c(2,2))
with(power_sel, plot(datetime, Global_active_power, type = "l", 
                     xlab = "", ylab = "Global Active Power"))
with(power_sel, plot(datetime, Voltage, type = "l"))
...
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"),
       col = c("black","red","purple"), lwd = 1, bty = "n")
with(power_sel, plot(datetime, Global_reactive_power, type = "l"))
dev.off()